...
namespace WHAT_API
{
    ...
    [AllureNUnit]
    class GET_GetAllMentors_Success : API_BaseTest
    {
        WhatAccount mentor;
        ...
        public GET_GetAllMentors_Success(Role role) : base()
        {
            this.role = role;
        }
        ...
        {
            api.log = LogManager.GetLogger($"Mentors/{nameof(GET_GetAllMentors_Success)}");
