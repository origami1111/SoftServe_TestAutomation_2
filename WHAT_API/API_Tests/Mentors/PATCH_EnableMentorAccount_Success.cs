...
namespace WHAT_API
{
    ...
    class PATCH_EnableMentorAccount_Success : API_BaseTest
    {
        ...
        public PATCH_EnableMentorAccount_Success(Role role) : base()
        {
            this.role = role;
        }
        ...
        [Test]
        public void VerifyEnableMentorAccount_Success()
        {
            api.log = LogManager.GetLogger($"Mentors/{nameof(PATCH_EnableMentorAccount_Success)}");
